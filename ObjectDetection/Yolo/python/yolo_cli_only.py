...
# Load YOLO model
config_path = '../data/yolov3.cfg'  # Path to YOLOv3 config file
weights_path = '../data/yolov3.weights'  # Path to YOLOv3 weights file
names_path = '../data/coco.names'  # Path to the file with class names
...
# Print bounding boxes and corresponding class names
if len(indices) > 0:
